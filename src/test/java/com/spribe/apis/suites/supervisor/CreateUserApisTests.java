...
@Epic("Create users")
@Feature("Create different type of users by Supervisor role")
public class CreateUserApisTests extends PlayerControllerTests {
    ...
    @Test
    @Description("Check that Supervisor is able to create new User and check response body.")
    ...
    @Test
    @Description("Check that Supervisor is able to create new User and user can be found in all users list.")
    ...
    @Test
    @Description("Check that Supervisor is able to create new Admin user and check response body.")
    public void createNewValidAdminResponseValidation() {
        ...
        //Or it could be verified with Hamcrest
    ...
    @Test
    @Description("Check that Supervisor is able to create new Admin user and user can be found in all users list.")
    ...
    @Test
    @Description("Check that Supervisor is not able to create new Supervisor user.")
