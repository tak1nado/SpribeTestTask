...
@Epic("Delete users")
@Feature("Delete different type of users by Supervisor role")
public class DeleteUserApisTests extends PlayerControllerTests {
    ...
    @Test
    @Description("Check that Supervisor is able to delete User and check response code.")
    ...
    @Test
    @Description("Check that Supervisor is able to delete User and user can not be found in all users list.")
    ...
    @Test
    @Description("Check that Supervisor is able to delete Admin and check response code.")
    ...
    @Test
    @Description("Check that Supervisor is able to delete Admin and user can not be found in all users list.")
    ...
    @Test(enabled = false)
    @Description("Check that Supervisor is not able to delete Supervisor/itself user.")
